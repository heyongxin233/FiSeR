...
class ClipModel(nn.Module):
    def __init__(self, name, opt, num_classes=1):
        ...
        self.should_log = (not getattr(opt, "distributed", False)) or getattr(opt, "local_rank", 0) == 0
        ...
        if self.should_log:
            print("Vision backbone params: total={}, trainable={}".format(num_total_param, num_param))
