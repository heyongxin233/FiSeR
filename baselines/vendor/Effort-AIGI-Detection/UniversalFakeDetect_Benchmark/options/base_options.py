...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--pretrained_name_or_path', type=str, default='',
                            help='optional local path or HuggingFace model id for the pretrained backbone')
        ...
        parser.add_argument('--train_lmdb', type=str, default='',
                            help='path to the training LMDB directory or data.mdb file')
        parser.add_argument('--val_lmdb', type=str, default='',
                            help='optional path to the validation LMDB directory or data.mdb file')
        parser.add_argument('--lmdb_path', type=str, default='',
                            help='path to the evaluation LMDB directory or data.mdb file')
        ...
        parser.add_argument('--distributed', action='store_true', help='enable torch.distributed training/testing')
        parser.add_argument('--local_rank', type=int, default=0, help='local rank used by torchrun')
        parser.add_argument('--compile', action='store_true', help='enable torch.compile when available')
        parser.add_argument('--compile_mode', type=str, default='reduce-overhead',
                            help='torch.compile mode, e.g. default or reduce-overhead')
        ...
        parser.add_argument('--precision', type=str, default='bf16-mixed',
                            ...
                            help='numerical precision used for forward/loss computation')
        parser.add_argument('--max_samples', type=int, default=None,
                            help='optional cap on the number of samples, useful for debugging')
        parser.add_argument('--max_steps_per_epoch', type=int, default=0,
                            help='optional cap on the number of steps per epoch, useful for debugging')
    ...
    def parse(self, print_options=True):
        ...
        if opt.arch.endswith('_svd'):
            opt.use_svd = True

        if print_options and (not opt.distributed or opt.local_rank == 0):
