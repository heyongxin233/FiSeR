...
class Trainer(BaseModel):
    ...
    def __init__(self, cfg: CONFIGCLASS):
        ...
        if cfg.warmup:
            cosine_epochs = max(cfg.nepoch - cfg.warmup_epoch, 1)
            scheduler_cosine = torch.optim.lr_scheduler.CosineAnnealingLR(
                self.optimizer, cosine_epochs, eta_min=1e-6
            )
            ...
            self.scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(self.optimizer, cfg.nepoch, eta_min=1e-6)
