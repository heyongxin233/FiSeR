...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dataroot', default='./dataset/', help='deprecated: image folder path (unused with lmdb)')
        parser.add_argument('--classes', default='', help='deprecated: image classes (unused with lmdb)')
    ...
    def parse(self, print_options=True):
        ...
        for str_id in str_ids:
            ...
            if device_count == 0:
                ...
                break
            if idx >= device_count:
                print(f'Warning: requested gpu id {idx} but only {device_count} visible; ignoring this id')
                continue
