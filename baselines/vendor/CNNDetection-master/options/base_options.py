...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dataroot', default='./dataset/', help='deprecated: old image folder path (unused with lmdb)')
        parser.add_argument('--classes', default='', help='deprecated: old image folder classes (unused with lmdb)')
