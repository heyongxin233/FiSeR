...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--train_split', type=str, default='train', help='train, val, test, etc (unused for lmdb)')
        parser.add_argument('--val_split', type=str, default='val', help='train, val, test, etc (unused for lmdb)')
        parser.add_argument('--niter', type=int, default=101, help='# of epochs at starting learning rate')
        ...
        parser.add_argument('--val_lmdb', type=str, default='', help='optional lmdb path for validation data')
