...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--min_lr_ratio', type=float, default=0.01, help='final learning rate as a ratio of the base lr')
        parser.add_argument('--epochs', type=int, default=None, help='number of training epochs (overrides niter)')
        parser.add_argument('--train_lmdb', type=str, default=None, help='path to training lmdb file')
        parser.add_argument('--val_lmdb', type=str, default=None, help='optional path to validation lmdb file')
