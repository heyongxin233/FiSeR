...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--train_lmdb', type=str, default='', help='lmdb path for training set')
        parser.add_argument('--val_lmdb', type=str, default='', help='optional lmdb path for validation set')
        parser.add_argument('--lmdb_path', type=str, default='', help='lmdb path for evaluation when testing')
